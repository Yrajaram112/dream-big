...
const SpendForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setStatus("Spend data submitted successfully!");
        setFormData({
          name: "",
          amount: "",
          reason: "",
  ...
  return (
    <section id="spent" className="overflow-hidden py-16 md:py-20 lg:py-28">
          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="wow fadeInUp shadow-three dark:bg-gray-dark mb-12 rounded-sm bg-white px-8 py-11 sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]" data-wow-delay=".15s">
              ...
              <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
                All types of Expenditures for Office Purposes
              </p>
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Spent Amount in NRs"
                  className="mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3"
                />
                <input
                  type="text"
